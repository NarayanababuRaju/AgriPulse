...
// in flutter_app/test/unit/diagnosis_provider_test.dart.
...
class MockAgriPulseService extends _i1.Mock implements _i6.AgriPulseService {
  @override
  _i3.Future<Map<String, dynamic>> analyzeCrop(
    _i7.XFile? imageFile,
    String? farmerId,
  ...
  @override
  _i3.Future<Map<String, dynamic>> getForecast(
    double? lat,
    double? lon,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<Map<String, dynamic>> getCurrentWeather(
    double? lat,
    double? lon,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<List<int>> synthesizeSpeech(
    String? text,
    String? languageCode,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<Map<String, dynamic>> predictYield({
  ...
  @override
  _i3.Future<Map<String, dynamic>> refineDiagnosis({
    required String? farmerId,
